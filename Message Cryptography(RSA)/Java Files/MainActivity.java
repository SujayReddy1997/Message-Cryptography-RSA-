...
public class MainActivity extends AppCompatActivity
    ...
    public BigInteger getmyD(){
        return D;
    }
    public void setmyD(BigInteger x){
        this.D=x;
    }
    public BigInteger getmyN(){
        return N;
    }
    public void setmyN(BigInteger y){
        this.N=y;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_Generate) {
            ...
            manager.beginTransaction().replace(R.id.layout,
                    generateFragment,
                    generateFragment.getTag()).commit();
